...
set_join_config_options(unsigned char enforce_mask, GucContext context)
{
	...
	// printf("set_join_config_options %d %d\n",mask,set_join_config_options);
...
make_join_rel_wrapper(PlannerInfo *root, RelOptInfo *rel1, RelOptInfo *rel2)
{
	...
	bms_free(joinrelids);
	// printf("----\n");
	// print_relids_yx(root, joinrelids);
	// printf("\n");
	// printf("hint.c:4434 ,make_join_rel_wrapper %d\n",hint);
	// fflush(stdout);
	if (current_hint_state->join_hint_level[root->join_cur_level]!=NULL && !hint) return NULL;
	if (!hint)
		return pg_hint_plan_make_join_rel(root, rel1, rel2);

	// printf("make_join_rel_wrapper inner_nrel %d\n",hint->inner_nrels);
	// fflush(stdout);
	if (hint->inner_nrels == 0)
	{
		save_nestlevel = NewGUCNestLevel();
		// printf("make_join_rel_wrapper %d %d\n",hint->enforce_mask,current_hint_state->context);
							 ...
							 List *restrictlist)
{
	...
	// print_relids_yx(root,joinrelids);
	// printf("hint.c:4484 %d ----",enable_hashjoin);
	// print_relids_yx(root,innerrel->relids);
	// printf("\n");
	// if (join_hint)
	// 	printf("hint.c:4480 join_hint->inner_nrels: %d %d\n",join_hint->inner_nrels);
	// else
	// 	printf("wrong\n");
	bms_free(joinrelids);
	if (join_hint && join_hint->inner_nrels != 0)
	{
		...
		if (bms_equal(join_hint->inner_joinrelids, innerrel->relids)||true)
		{
			// printf("add_paths_to_joinrel_wrapper 1\n");
			// fflush(stdout);
		...
		{
			// printf("add_paths_to_joinrel_wrapper 0\n");
			// fflush(stdout);
						 ...
						 List *initial_rels)
{
	 ...
	 * calls.
	 */
	// printf("hint.c 4566 pg_hint_plan_join_search %d\n",enable_hashjoin);
	...
	// printf("hint.c 4592 pg_hint_plan_join_search %d\n",enable_hashjoin);
